...
from src.interruption_handlers import KillInterruptionHandler, STATE_TERMINATED
...
class TestKillInterruptionHandler(TestCase):
    def setUp(self):
        ...
        self._kill = KillInterruptionHandler(self._scheduler, self._pcbTable, self._dispatcher)
